...
# ── MediaMTX binary from official image ───────────────────────────────────────
# Tag format is "1.9.3" (no "v" prefix). Binary is at /mediamtx inside image.
FROM bluenviron/mediamtx:1.9.3 AS mediamtx-source
